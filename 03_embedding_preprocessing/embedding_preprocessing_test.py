...
final_metadata.to_csv(os.path.join(OUT_DIR, "final_metadata_test.csv"), index=False)
torch.save(final_img_embs, os.path.join(OUT_DIR, "final_image_embeddings_test.pt"))
torch.save(final_wav_embs, os.path.join(OUT_DIR, "final_audio_embeddings_test.pt"))
